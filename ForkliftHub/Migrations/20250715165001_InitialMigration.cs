    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MastTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MastTypeId = table.Column<int>(type: "int", nullable: false),
                    LiftingHeight = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    ClosedHeight = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_Engines_EngineId",
                        column: x => x.EngineId,
                        principalTable: "Engines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Products_MastTypes_MastTypeId",
                        column: x => x.MastTypeId,
                        principalTable: "MastTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 2, 4, 0m, "Reliable used diesel forklift for heavy lifting.", 1, null, 0m, 1, 2, "Used Hyster Diesel Forklift", 14000m, 2, 0 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_EngineId",
                table: "Products",
                column: "EngineId");

            migrationBuilder.CreateIndex(
                name: "IX_Products_MastTypeId",
                table: "Products",
                column: "MastTypeId");
